...
- 4. TODO memo enumerate, with same parameters as webppl enumerate (xiang2023-exp1-round3-memo.qmd)
- 5. moonshot: memo enumerate, but the equilibrium-finding process uses memo frames (still accelerated by JAX, but now in the language of memo)
