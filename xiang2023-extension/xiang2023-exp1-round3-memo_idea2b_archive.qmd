...
Code adapted from https://github.com/jczimm/competence_effort/blob/main/Code/main_text/exp1_simulation.R and memo-sandbox/webppl vs memo/xiang2023-exp1-round3-memo.qmd

TODO: also inform competence using some perceived competence
...
gamma = 1. # strength of belief that agent will achieve optimal effort, and belief in perceived effort (see ..._idea2c.qmd) # TEMP
...
@memo(save_comic="memo-comic-xiang-strength-inference_add_perceived_effort", debug_trace=DEBUG, debug_print_compiled=DEBUG)
