...
def infer_strengths[query_sa: strength_values, query_sb: strength_values](
    ...
    participant: thinks[
        ...
        agent_a: given(r1_actual_effort in efforts,
            ...
            norm.pdf(r1_actual_effort, {gamma}, r1_opt_effort) *
            norm.pdf(r1_perceived_effort_a, {delta}, r1_actual_effort)
    ...
    participant: thinks[
        ...
        agent_b: given(r1_actual_effort in efforts,
            wpp=
                norm.pdf(r1_actual_effort, {gamma}, r1_opt_effort) *
                norm.pdf(r1_perceived_effort_b, {delta}, r1_actual_effort)
        )
    ]
    ...
    participant: thinks[
        ...
        agent_a: given(r2_actual_effort in efforts,
            wpp=
                norm.pdf(r2_actual_effort, {gamma}, r2_opt_effort) *
                norm.pdf(r2_perceived_effort_a, {delta}, r2_actual_effort)
        )
    ]
    ...
    participant: thinks[
        ...
        agent_b: given(r2_actual_effort in efforts,
            wpp=
                norm.pdf(r2_actual_effort, {gamma}, r2_opt_effort) *
                norm.pdf(r2_perceived_effort_b, {gamma}, r2_actual_effort)
        )
    ]
